...
class MarkdownDownloader {
  ...
  static makeBody(item, options) {
    return __awaiter(this, void 0, void 0, function*() {
      let body = yield ImageDownloader_1.ImageDownloader.getMarkdownImages(
        item.body,
        options.staticDir,
        options.imgDir
      );
      body = yield ImageDownloader_1.ImageDownloader.getHTMLImages(
        body,
        options.staticDir,
        options.imgDir
      );
...
`;
      const filePath = path.resolve(
        options.contentsDir,
        options.mdDir,
        `${date_fns_1.format(date, "yyyy-MM-dd-HHmmss_")}${item.id}.md`
      );
