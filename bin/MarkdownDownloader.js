...
class MarkdownDownloader {
    ...
    static makeBody(item, options) {
        return __awaiter(this, void 0, void 0, function* () {
            let body = yield ImageDownloader_1.ImageDownloader.getMarkdownImages(item.body, options.imgDir);
            body = yield ImageDownloader_1.ImageDownloader.getHTMLImages(body, options.imgDir);
            return body;
        });
    }
