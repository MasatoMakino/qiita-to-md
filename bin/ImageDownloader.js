...
class ImageDownloader {
     ...
     * @param imgDir
     */
    static getMarkdownImages(markdown, imgDir) {
        return __awaiter(this, void 0, void 0, function* () {
            const regex = /(\!\[.*\]\()(https:\/\/qiita-image-store.*.com\/.*\/([a-z0-9\-]+\.(gif|jpe?g|png)))(\))/g;
            return yield this.convertImageLink(regex, markdown, imgDir);
        });
    }
    /**
     ...
     * @param imgDir
     */
    static getHTMLImages(markdown, imgDir) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param imgDir
     */
    static convertImageLink(regex, markdown, imgDir) {
     ...
     * @param fileName
     */
    static downloadImage(url, imgDir, fileName) {
        return __awaiter(this, void 0, void 0, function* () {
