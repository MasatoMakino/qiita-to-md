...
class OptionsUtil {
    static init(options) {
        ...
        options.staticDir = (_d = options.staticDir, (_d !== null && _d !== void 0 ? _d : "./static/"));
        options.imgDir = (_e = options.imgDir, (_e !== null && _e !== void 0 ? _e : "img/post"));
        options.token = (_f = options.token, (_f !== null && _f !== void 0 ? _f : path.resolve(".qiita_token.json")));
        return options;
    }
}
