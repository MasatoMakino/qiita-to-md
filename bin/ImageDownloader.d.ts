export declare class ImageDownloader {
     ...
     * @param imgDir
     */
    static getMarkdownImages(markdown: string, staticDir: string, imgDir: string): Promise<string>;
    /**
     * <img>タグで記載されたQiitaサーバー内の画像をダウンロードし、参照URLを書き換える。
     * @param markdown
     * @param imgDir
     */
    static getHTMLImages(markdown: string, staticDir: string, imgDir: string): Promise<string>;
    /**
     ...
     * @param imgDir
     */
    static convertImageLink(regex: RegExp, markdown: any, staticDir: string, imgDir: string): Promise<string>;
    /**
     * 画像をダウンロードし、保存する
     * @param url
     * @param staticDir
